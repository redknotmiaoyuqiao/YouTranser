...
set -e
export PKG_CONFIG_PATH=${basepath}/Lib/x265_install/lib/pkgconfig/
...
--extra-ldflags="-L${basepath}/Lib/x264_install/lib/ -L${basepath}/Lib/lame_install/lib/ -L${basepath}/Lib/fdk_aac_install/lib/ -L${basepath}/Lib/x265_install/lib/ -L${basepath}/Lib/openssl_install/lib/ -L${basepath}/Lib/libvpx_install/lib/ -L${basepath}/Lib/libopus_install/lib/ -lstdc++ -lm"
